...
<div class="form-group row gutters-tiny mb-0 items-push">
	<div class="col-md-12">
		...
		<?php
				...
				echo anchor("Car","<p class='text-center'><button class='btn btn-alt-success'><i class='fa fa-refresh'></i> Click to refresh the page</button></p>");
			}
		} ?>
