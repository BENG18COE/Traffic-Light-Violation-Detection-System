            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('assets/media/photos/accident.jpg');">
                    <div class="row mx-0 bg-black-op">
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                ...
                                <p class="font-italic text-white-op">
                                    <a class="font-w600" href="" target="_blank">traffic</a> &copy; <span><?php echo date('Y'); ?></span>
                                </p>
                            </div>
                        </div>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="<?php echo site_url('Auth'); ?>" >
                                        ...
                                        <span class="font-size-xl text-primary-dark">Tra </span><span class="font-size-xl">ffic</span>
                                    </a>
                                ...
                                <?php echo form_open("", array('class'=>'px-30')); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="mt-30">
                                            <a class="link-effect text-primary mr-10 mb-5 d-inline-block" href="#" id="actionModal" d="0" o="1" f="owner" c="Base" >
                                                <i class="fa fa-check-circle-o mr-5"></i> Verify incidence
                                            </a>
